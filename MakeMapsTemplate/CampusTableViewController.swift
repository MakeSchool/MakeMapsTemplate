...
class CampusTableViewController: UITableViewController {
    ...
    private func add(){
        let alert = UIAlertController(title: "Custom Location", message: "Enter your current location", preferredStyle: UIAlertControllerStyle.Alert)
    ...
    private func wordEntered(alert: UIAlertAction!){
        let textView2 = self.newWordField.text
        if textView2 != ""{
            print("You selected location: \(textView2)")
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            print("You selected location: \(location)")
